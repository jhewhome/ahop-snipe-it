    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-default ahop-panel ahop-appointments-panel">
                ...
                <div class="box-body">
                    <div class="btn-group ahop-appointments-calendar-nav">
                    ...
                    <div class="row ahop-appointments-calendar-grid">
                        @foreach ($days as $day)
                            <div class="col-md-6 col-lg-4 ahop-appointments-calendar-col">
                                <div class="panel panel-default ahop-appointments-day-card">
                                    <div class="panel-heading ahop-appointments-day-header">
                                        <strong>{{ $day['label'] }}</strong>
                                        <span class="badge pull-right">{{ $day['appointments']->count() }}</span>
                                    </div>
                                    <div class="panel-body ahop-appointments-day-body">
                                        @forelse ($day['appointments'] as $appt)
                                            <div class="ahop-appointments-day-item">
                                        ...
                                        @empty
                                            <p class="text-muted ahop-appointments-day-empty">{{ trans('admin/appointments/table.no_appointments') }}</p>
                                        @endforelse
                                    </div>
                                </div>
                            </div>
